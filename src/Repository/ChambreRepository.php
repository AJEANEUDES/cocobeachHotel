...
class ChambreRepository extends ServiceEntityRepository
{
    ...
    public function findAllChambresLibres()
    {
        $entityManager = $this->getEntityManager();

        $query = $entityManager->createQuery(
            "SELECT chambre
            FROM App\Entity\Chambre chambre
            WHERE chambre.delete_chambre = false
            AND chambre.etat_chambre = false
            ORDER BY chambre.date_creation desc"
        );
